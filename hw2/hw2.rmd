...
Looking at the acceptance rates, we observe that $Q_2$ constantly has a higher acceptance rate.
...
```{r echo=FALSE, message=FALSE, warning=FALSE}
rbind(data.frame(batchmeans::bm(apply(sample1, 1, diag_all_one))),
